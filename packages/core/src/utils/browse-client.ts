...
export class BrowseClient {
  private readonly browsePath: string;
  ...
  ): Promise<ReadonlyArray<SearchExtractResult>> {
    const results: SearchExtractResult[] = [];
   ...
   */
  private buildSearchUrl(source: string, query: string): string {
