...
<body>
  ...
  <div class="content">
     ...
     */
    async exportChapter(chapter, outputPath, options) {
     ...
     */
    async exportChapters(chapters, outputPath, memoirInfo, options) {
        // Create cover page
        let coverHTML = "";
        if (memoirInfo) {
            coverHTML = `
...
<body>
  ...
  ${chaptersHTML}
     ...
     */
    async exportMemoir(memoir, chapters, outputPath, options) {
