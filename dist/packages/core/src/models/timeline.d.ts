 ...
 * Event categories
 */
export type EventCategory = "birth" | "education" | "career" | "family" | "residence" | "travel" | "health" | "achievement" | "milestone" | "historical_context";
/**
 * Timeline
 */
...
export interface TimelineBuildRequest {
    readonly userId: string;
    readonly interviewAnswers: ReadonlyArray<{
...
export interface TimelineVerificationResult {
    readonly verifiedEvents: ReadonlyArray<{
        readonly eventId: string;
        readonly verified: boolean;
    }>;
